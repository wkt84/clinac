...
// $Id$
//
/// \file BOptnBremSplitting.hh
/// \brief Definition of the BOptnBremSplitting class
//
//---------------------------------------------------------------
//
// BOptnBremSplitting
...
#ifndef BOptnBremSplitting_hh
#define BOptnBremSplitting_hh 1

#include "G4VBiasingOperation.hh"
#include "G4ParticleChange.hh"


class BOptnBremSplitting : public G4VBiasingOperation {
public:
  // -- Constructor :
  BOptnBremSplitting(G4String name);
  // -- destructor:
  virtual ~BOptnBremSplitting();
