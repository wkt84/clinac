...
// $Id$
///
/// \file BOptrBremSplitting.hh
/// \brief Definition of the BOptrBremSplitting class
#ifndef BOptrBremSplitting_hh
#define BOptrBremSplitting_hh 1

#include "G4VBiasingOperator.hh"
class BOptnBremSplitting;
class G4GenericMessenger;

class BOptrBremSplitting : public G4VBiasingOperator {
public:
  BOptrBremSplitting();
  virtual ~BOptrBremSplitting() {}
...
private:
  BOptnBremSplitting* fBremSplittingOperation;
