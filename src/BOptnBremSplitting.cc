...
// $Id$
//
/// \file BOptnBremSplitting.cc
/// \brief Implementation of the BOptnBremSplitting class
...
BOptnBremSplitting::BOptnBremSplitting(G4String name)
...
BOptnBremSplitting::~BOptnBremSplitting()
{
}
