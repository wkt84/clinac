...
// $Id$
//
/// \file BOptrBremSplitting.cc
/// \brief Implementation of the BOptrBremSplitting class

#include "BOptrBremSplitting.hh"
#include "BOptnBremSplitting.hh"
...
BOptrBremSplitting::BOptrBremSplitting()
: G4VBiasingOperator("BremSplittingOperator"),
  fSplittingFactor(1),
  fBiasPrimaryOnly(true),
  fBiasOnlyOnce(true)
{
  fBremSplittingOperation = new BOptnBremSplitting("BremSplittingOperation");
  
  // -- Define messengers:
  // -- Splitting factor:
  fSplittingFactorMessenger = 
    new G4GenericMessenger(this, "/biasing/","Biasing control" );
...
void BOptrBremSplitting::StartRun()
{
...
void BOptrBremSplitting::StartTracking( const G4Track* /* track */ )
{
